...
var NgModelController = ['$scope', '$exceptionHandler', '$attrs', '$element', '$parse', '$animate',
  ...
  try {
   var evaluatedModel = $scope.evaluateModel ? "formData."+$scope.$eval($attr.ngModel) : undefined;
   console.log("evaluatedModel: " + evaluatedModel);
  } catch(err) {
    console.log("error during eval " + $attr.ngModel);
  }

  var newNgModel = (evaluatedModel !== undefined) ? evaluatedModel : $attr.ngModel;

  var ngModelGet = $parse(newNgModel),
